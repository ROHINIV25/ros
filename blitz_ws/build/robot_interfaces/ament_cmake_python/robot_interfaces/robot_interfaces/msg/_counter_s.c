...
bool robot_interfaces__msg__counter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._counter.Counter", full_classname_dest, 37) == 0);
  }
  robot_interfaces__msg__Counter * ros_message = _ros_message;
  {  // a
...
PyObject * robot_interfaces__msg__counter__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._counter");
