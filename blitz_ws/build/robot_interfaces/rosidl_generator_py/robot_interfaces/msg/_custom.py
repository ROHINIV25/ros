...
class Custom(metaclass=Metaclass_Custom):
    ...
    def __init__(self, **kwargs):
        ...
        self.servo_angle = kwargs.get('servo_angle', float())
    ...
    def __eq__(self, other):
        ...
        if self.button != other.button:
            return False
        if self.servo_angle != other.servo_angle:
            return False
    ...
    def button(self, value):
        if self._check_fields:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'button' field must be an integer in [-32768, 32767]"
        self._button = value

    @builtins.property
    def servo_angle(self):
        """Message field 'servo_angle'."""
    ...
    def servo_angle(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'servo_angle' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'servo_angle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def pwm(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'pwm' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._pwm = value
